...
<body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="verDetalle(<?= htmlspecialchars(json_encode($aspirante)) ?>)">
                            Ver Detalle
                        </button>
                    </td>
                </tr>
    ...
    <div id="modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); justify-content:center; align-items:center;">
        <div style="background:white; padding:30px; width:500px; border-radius:8px;">
            ...
            <p><strong>Residencia:</strong> <span id="modal-residencia"></span></p>
            <p><strong>Fecha Nacimiento:</strong> <span id="modal-fecha"></span></p>
            <p><strong>Estado Civil:</strong> <span id="modal-estado-civil"></span></p>
            <p><strong>Género:</strong> <span id="modal-genero"></span></p>
            <p><strong>Nacionalidad:</strong> <span id="modal-nacionalidad"></span></p>
    ...
    <script>
        ...
        function verDetalle(aspirante) {
            ...
            document.getElementById('modal-nombre').textContent = aspirante.nombre + ' ' + aspirante.apellido;
            document.getElementById('modal-cedula').textContent = aspirante.cedula;
            document.getElementById('modal-correo').textContent = aspirante.correo;
            document.getElementById('modal-telefono').textContent = aspirante.telefono;
            document.getElementById('modal-residencia').textContent = aspirante.residencia;
            document.getElementById('modal-fecha').textContent = aspirante.fecha_nacimiento;
            document.getElementById('modal-estado-civil').textContent = aspirante.estado_civil;
            document.getElementById('modal-genero').textContent = aspirante.genero;
            document.getElementById('modal-nacionalidad').textContent = aspirante.nacionalidad;
            document.getElementById('modal-estado').value = aspirante.estado;
